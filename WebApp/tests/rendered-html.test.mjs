...
test("shows independent public sign-in without exposing provider secrets", async () => {
  ...
  assert.match(loginHTML, /Release 0\.2\.0-beta\.4/);
  assert.match(loginHTML, /name="asitra-release" content="0\.2\.0-beta\.4"/);
...
test("publishes one traceable release number", async () => {
  ...
  assert.match(releaseSource, /ASITRA_RELEASE = "0\.2\.0-beta\.4"/);
